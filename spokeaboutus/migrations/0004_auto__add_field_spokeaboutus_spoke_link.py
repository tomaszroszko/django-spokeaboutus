...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpokeAboutUs.spoke_link'
        db.add_column(u'spokeaboutus_spokeaboutus', 'spoke_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpokeAboutUs.spoke_link'
        db.delete_column(u'spokeaboutus_spokeaboutus', 'spoke_link')
